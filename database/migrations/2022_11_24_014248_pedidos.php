...
Schema::create('pedidos', function (Blueprint $table) {
    ...
    $table->foreign('id_metodo_entrega')->references('id')->on('metodo__entregas')->onDelete("cascade");
    $table->foreign('id_metodo_pago')->references('id')->on('metodo__pagos')->onDelete("cascade");
