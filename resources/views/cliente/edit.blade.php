                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="cedula"
                                                    value="{{ isset($cliente->cedula) ? $cliente->cedula : '' }}"
                                                ...
                                                <select class="form-control" name="tipo_persona" id="tipo_persona" required>
                                                    @forelse($tipo_persona as $tipo_personas)
                                                        <option value="{{ $tipo_personas->id }}"
                                                            {{ $tipo_personas->id == $cliente->tipo_persona ? 'selected' : '' }}>
                                                ...
                                                <select class="form-control" name="regimen" id="regimen" required>
                                                    @forelse($regimen as $regi)
                                                        <option value="{{ $regi->id }}"
                                                            {{ $regi->id == $cliente->regimen ? 'selected' : '' }}>
                                                            {{ $regi->nombre }}
                                                        </option>
                                                    @empty
                                                        <option>No existen</option>
                                                ...
                                                <select class="form-control" name="tipo_comercio" id="tipo_comercio"
                                                    ...
                                                    @forelse($tipo_comercio as $tipocomercio)
                                                        <option value="{{ $tipocomercio->id }}"
                                                            {{ $tipocomercio->id == $cliente->tipo_comercio ? 'selected' : '' }}>
                                                            {{ $tipocomercio->nombre }}
                                                        </option>
                                                    @empty
                                                        <option>No existen</option>
