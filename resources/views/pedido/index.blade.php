...
@section('content')
                ...
                <tbody>
                    @foreach ($clientes as $cliente)
                        <tr>
                            ...
                            <td><?php if ($cliente->proceso == '0') {
                                echo 'Pendiente';
                            } elseif ($cliente->proceso == '1') {
                                echo 'Despachado';
                            } else {
                                echo 'Entregado';
                            } ?></td>
                            <td>
                                <button onclick="verDatos('{{ $cliente->id }}')" class="mdi mdi-format-align-justify"+
                                    data-toggle="modal" data-target="#verdetalle"></button>
                                <button class="mdi mdi-cash-usd" data-toggle="modal" data-target="#abonos"></button>
                                <button onclick="editarPedido('{{ $cliente->id }}')" class="mdi mdi-lead-pencil"
                                    data-toggle="modal" data-target="#editarmodal"></button>
                                <button onclick="anularPedido('{{ $cliente->id }}')" class="mdi mdi-block-helper"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    <input type="text" name="idanular" id="idanular" />
                    <input type="text" name="estadoanular" id="estadoanular" />
                    <div>¿Está seguro que desea anular el pedido?
                    </div>
                    <input type="text" name="anulardato" value="2" />
                    <button type="submit" onclick="confirmarAnularPedido()" class="btn btn-primary" data-dismiss="modal">Si</button>
                                        ...
                                        <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                                            ...
                                            <div class="text-grey-m2">
                                                ...
                                                <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i>
                                                    <span class="text-600 text-90" id="idpedidodetalle"></span></div>
                                                ...
                                                <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i>
                                                    <span class="text-600 text-90" id="procesopedidodetalle"></span></div>
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
    ...
    <script>
        ...
        function editarPedido(id) {
            let consulta = <?php echo $editarpedido; ?>;
        ...
        function confirmarAnularPedido() {
            let idanularpedido = $('#idanular').val();
            $.ajax({
                type: "PUT",
                url:"{{ route('pedidos.anularPedido') }}",
                data:{id:idanularpedido},
                dataType: "jsonp",
